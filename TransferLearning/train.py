    ...
    for epoch in progressbar:
        if epoch > 0:
            ...
            for bb, (x, y_B) in enumerate(tr_loader):
                ...
                loss_l2 = sum((param ** 2).sum() for param in model.parameters() if param.requires_grad and param.ndim > 1)
        ...
        with torch.no_grad():
            ...
            for xva_B3HW, yva_B in va_loader:
                ...
                va_xent += xent_loss_func(logits_BC, yva_B.to(device)).item() / len(va_loader)
